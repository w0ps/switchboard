...
Meteor.methods({
  ...
  updateAutogeneratedTagChatMessages: function( needSourceId ) {
    ...
    console.log ("------updateAutogeneratedTagChatMessages-------");
    ...
    for (index = 0; index < tempNeeds.length; ++index) {
        ...
        TagChatMessages.insert( new ChatMessage( { text: tempNeed.title, sourceId: needSourceId, created: tempNeed.created, createdBy: tempNeed.createdBy, autoGenerated: 1 } ) );
        
        console.log ("TagChatMessages.insert: " + tempNeed.title + " "+ needSourceId + " " +  tempNeed.createdBy );
